...
f,a = plt.subplots(3,2)
im = a[0,0].imshow(eigenvectors[...,0].squeeze().T.cpu().numpy())
f.colorbar(im, ax=a[0,0],fraction=0.046,location='right')
a[0,0].set_title('e_0')

im = a[0,1].imshow(eigenvectors[...,1].squeeze().T.cpu().numpy())
f.colorbar(im, ax=a[0,1],fraction=0.046,location='right')
a[0,1].set_title('e_1')

im = a[1,0].imshow(eigenvectors[...,2].squeeze().T.cpu().numpy())
f.colorbar(im, ax=a[1,0],fraction=0.046,location='right')
a[1,0].set_title('e_2')

im = a[1,1].imshow(eigenvectors[...,3].squeeze().T.cpu().numpy())
f.colorbar(im, ax=a[1,1],fraction=0.046,location='right')
a[1,1].set_title('e_3')

im = a[2,0].imshow(eigenvectors[...,4].squeeze().T.cpu().numpy())
f.colorbar(im, ax=a[2,0],fraction=0.046,location='right')
a[2,0].set_title('e_4')

im = a[2,1].imshow(eigenvectors[...,5].squeeze().T.cpu().numpy())
f.colorbar(im, ax=a[2,1],fraction=0.046,location='right')
a[2,1].set_title('e_5')
